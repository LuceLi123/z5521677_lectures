...
# ---------------------------------------------------------------------------- 
# This will open the file located at `SRCFILE` and return a handler (file object):
...
# Start with an empty string: Return nothing
cnts_copy = ''
...
# close the file: Must! to avoid clapping
fobj.close()
...
# Read the first line: Read line by line
...
# ---------------------------------------------------------------------------- 
#   Using context managers -- Part of Project 1
# ---------------------------------------------------------------------------- 
...
def print_lines(pth):
    ...
    with open(pth) as fobj:
        for i, line in enumerate(fobj):  # enumerate return tuples
            print(f"line {i}: {line}")
