...
import pprint as pp  # To show the print clearly


def printit(obj, msg):
    """ Pretty printer. Print both the object `obj`, its type, and the object ID
    Parameters
    ----------
    obj: Any instance
    msg: str, optional
...
def example4():
    """ Nested lists
    Have 3 different lists in the following example
    """
...
def example5():
    ...
    Have 4 different lists in the following
    """
...
def example6():
    ...
    lst1 = copy.copy(lst0)  # Create outer list -- a.b: if a = b is identical, then it returns true.
...
def example7():
    ...
    lst3 = copy.deepcopy(lst1)  # Create inner list
